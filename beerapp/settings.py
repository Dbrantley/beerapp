...
SECRET_KEY = 'lopqkz77ln%y0bbj3&+k_w+)me%^9ae8gnd$-2lhh$!kwibqj1'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "beerapp/static"),
]
STATIC_ROOT = os.path.join(BASE_DIR, 'beerapp/staticcdn', )
